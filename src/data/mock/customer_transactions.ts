...
export const customer_transactions: CustomerTransaction[] = [
    ...
    { id: "txn_v30_r01", customer_id: "cust_ahmed_zayn",     branch_id: SOUTH, kind: "package",    product_id: "pkg_10_class",       name: "10-Class Package for One Month", amount_aed: -1390, status: "refunded", payment_method: "card", refund_method: "card", transaction_type: "refund", original_transaction_id: "txn_v30_s01", refund_reason: "Customer relocated — moved to Dubai", staff_id: "staff_maya_johnson", created_at: "2026-02-20T10:30:00Z", refunded_at: "2026-02-20T10:30:00Z" },
    { id: "txn_v30_r02", customer_id: "cust_zahra_mahen",    branch_id: "branch_forma_east", kind: "membership", product_id: "mem_yoga_focused",     name: "Yoga Focused Monthly Membership", amount_aed: -1620, status: "refunded", payment_method: "card", refund_method: "card", transaction_type: "refund", original_transaction_id: "txn_v30_s05", refund_reason: "Medical",                     created_at: "2026-03-05T14:15:00Z", refunded_at: "2026-03-05T14:15:00Z" },
    { id: "txn_v30_r03", customer_id: "cust_sophia_lee",     branch_id: SOUTH, kind: "package",    product_id: "pkg_20_class",       name: "20-Class Package for One Month", amount_aed: -2400, status: "refunded", payment_method: "card", refund_method: "card", transaction_type: "refund", original_transaction_id: "txn_v30_s06", refund_reason: "Billing error",         created_at: "2026-03-22T09:00:00Z", refunded_at: "2026-03-22T09:00:00Z" },
    { id: "txn_v30_r04", customer_id: "cust_fatima_al_sayed",branch_id: SOUTH, kind: "membership", product_id: "mem_advanced_monthly", name: "Advanced Monthly Membership",   amount_aed: -1500, status: "refunded", payment_method: "cash", refund_method: "cash", transaction_type: "refund", original_transaction_id: "txn_v30_s08", refund_reason: "Studio cancelled",           staff_id: "staff_liam_chen",    created_at: "2026-04-15T16:20:00Z", refunded_at: "2026-04-15T16:20:00Z" },
    { id: "txn_v30_r05", customer_id: "cust_ahmed_zayn",     branch_id: SOUTH, kind: "package",    product_id: "pkg_1_class_intro",  name: "Intro",                  amount_aed:  -170, status: "refunded", payment_method: "card", refund_method: "card", transaction_type: "refund", original_transaction_id: "txn_v30_s11", refund_reason: "Booked by mistake",              created_at: "2026-05-08T11:00:00Z", refunded_at: "2026-05-08T11:00:00Z" },
    { id: "txn_v30_r06", customer_id: "cust_ava_wright",     branch_id: "branch_forma_east", kind: "membership", product_id: "mem_yoga_focused",     name: "Yoga Focused Monthly Membership", amount_aed: -1800, status: "refunded", payment_method: "card", refund_method: "card", transaction_type: "refund", original_transaction_id: "txn_v30_s12", refund_reason: "Medical",                     created_at: "2026-05-20T13:30:00Z", refunded_at: "2026-05-20T13:30:00Z" },
    { id: "txn_v30_r07", customer_id: "cust_bosa_ahmed",     branch_id: SOUTH, kind: "package",    product_id: "pkg_10_class",       name: "10-Class Package for One Month", amount_aed: -1390, status: "refunded", payment_method: "card", refund_method: "card", transaction_type: "refund", original_transaction_id: "txn_v30_s13", refund_reason: "Customer relocated — moved out of country",         created_at: "2026-06-12T10:45:00Z", refunded_at: "2026-06-12T10:45:00Z" },
    { id: "txn_v30_r08", customer_id: "cust_sophia_lee",     branch_id: SOUTH, kind: "membership", product_id: "mem_yoga_focused",     name: "Yoga Focused Monthly Membership", amount_aed: -1800, status: "refunded", payment_method: "card", refund_method: "card", transaction_type: "refund", original_transaction_id: "txn_v30_s18", refund_reason: "Booked by mistake",         staff_id: "staff_maya_johnson", created_at: "2026-06-25T15:00:00Z", refunded_at: "2026-06-25T15:00:00Z" },

    // ── Cross-kind + split refunds (client 2026-08-19) — proves the Refunds
    //    report + refund modal cover POS/retail, private & recovery sessions,
    //    gift cards, split payments, and Apple/Google Pay, not just memberships.
    { id: "txn_ret_ref01",   customer_id: "cust_zahra_mahen",    branch_id: SOUTH, kind: "retail",   product_id: "retail_prod_grip_socks", name: "Grip Socks",       amount_aed:  -60, status: "refunded", payment_method: "card",     refund_method: "card",     card_type: "mastercard", transaction_type: "refund", original_transaction_id: "txn_ret_005", refund_reason: "Retail return",     staff_id: "user_sam_admin",     created_at: "2026-07-02T10:00:00Z", refunded_at: "2026-07-02T10:00:00Z", retail_product_id: "retail_prod_grip_socks", product_snapshot_name: "Grip Socks", product_snapshot_sku: "APP-SOK-002", product_snapshot_price_aed: 60, product_snapshot_unit_cost_aed: 22, quantity: 1, branch_id_at_sale: SOUTH },
    { id: "txn_priv_ref01",  customer_id: "cust_ava_wright",     branch_id: SOUTH, kind: "private",  product_id: "svc_private_reformer",   name: "Private Reformer", amount_aed: -320, status: "refunded", payment_method: "applepay", refund_method: "applepay",                          transaction_type: "refund",                                        refund_reason: "Not satisfied",     staff_id: "staff_maya_johnson", created_at: "2026-07-14T09:30:00Z", refunded_at: "2026-07-14T09:30:00Z" },
    { id: "txn_recov_ref01", customer_id: "cust_bosa_ahmed",     branch_id: "branch_forma_east", kind: "recovery", product_id: "svc_recovery_sauna", name: "Recovery Sauna", amount_aed: -180, status: "refunded", payment_method: "googlepay", refund_method: "googlepay",                        transaction_type: "refund",                                        refund_reason: "Medical",           created_at: "2026-07-20T16:00:00Z", refunded_at: "2026-07-20T16:00:00Z" },
    { id: "txn_gc_ref01",    customer_id: "cust_sophia_lee",     branch_id: SOUTH, kind: "gift_card", product_id: "gc_design_aed_250",      name: "AED 250 Gift Card", amount_aed: -250, status: "refunded", payment_method: "card",    refund_method: "card",     card_type: "visa",       transaction_type: "refund",                                        refund_reason: "Booked by mistake", staff_id: "staff_maya_johnson", created_at: "2026-07-25T11:00:00Z", refunded_at: "2026-07-25T11:00:00Z" },
    // Complete + refundable — open the Refund modal on these to see the
    // "Paid with / Refunds to" breakdown: Apple Pay, and a card + wallet split.
    { id: "txn_priv_apay01", customer_id: "cust_ahmed_zayn",     branch_id: SOUTH, kind: "private",    product_id: "svc_private_reformer",  name: "Private Reformer",            amount_aed:  320, subtotal_aed:  305, tax_aed: 15, tax_rate_percentage: 5, tax_inclusive: false, status: "complete", payment_method: "applepay", payment_source: "pos",                          payment_type: "one_off", transaction_type: "sale", tax_treatment: "standard", staff_id: "staff_maya_johnson", created_at: "2026-08-01T10:00:00Z", settlement_iso: "2026-08-02T10:00:00Z" },
    { id: "txn_split01",     customer_id: "cust_fatima_al_sayed", branch_id: SOUTH, kind: "membership", product_id: "mem_advanced_monthly", name: "Advanced Monthly Membership", amount_aed: 1000, subtotal_aed:  952, tax_aed: 48, tax_rate_percentage: 5, tax_inclusive: false, status: "complete", payment_method: "card", payment_source: "pos", card_type: "visa", payment_type: "one_off", transaction_type: "sale", tax_treatment: "standard", account_credit_applied_aed: 200, staff_id: "staff_liam_chen", created_at: "2026-08-03T14:00:00Z", settlement_iso: "2026-08-04T14:00:00Z" },
