...
export const notifications_instructor: NotificationSeed[] = [
    // ── Today — bookings (unread) ────────────────────────────────────────────
    {
        ...
        event: "new_booking",
        title: "New Booking",
        body: "Ahmed Zayn booked your Reformer Pilates class today at 6 PM. Now 6/6 spots filled.",
        icon: "calendar-check",
    ...
    },
    {
        ...
        event: "class_full",
        title: "Class Full",
        body: "Your Reformer Pilates class today at 6 PM is now full (6/6). 2 members on the waitlist.",
        icon: "calendar-check",
        source_module: "class",
        class_schedule_id: "class_sched_demo_liam_006",
        branch_id: "branch_forma_south",
    ...
    },
    {
        ...
        event: "cancellation",
        title: "Cancellation",
        body: "Rosale Martin cancelled your Reformer Pilates class today at 1 PM. 6/8 spots filled, 1 on waitlist.",
        icon: "calendar-minus",
        source_module: "booking",
