...
export const SETTINGS_GROUPS: SettingsGroupDef[] = [
    ...
    },
    {
        ...
        icon: Settings03,
        tabs: [
            // Offerings (client 2026-08-04) — studio-level on/off switches for
            // the optional offering types (Memberships / Private sessions /
            ...
            { label: "Offerings",           href: "/admin/settings/offerings"           },
