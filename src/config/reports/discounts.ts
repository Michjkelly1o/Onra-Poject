...
export const DISCOUNTS_REPORT: ReportDefinition = {
    ...
    columns: [
        ...
        { key: K.txnId,                label: "Transaction #",           kind: "id",       minWidth: 200, hiddenByDefault: true },
        ...
        { key: K.itemPackage,          label: "Item",                    kind: "text",     minWidth: 240 },
        { key: K.revenueCategoryLabel, label: "Sale category",           kind: "text",     minWidth: 160, hiddenByDefault: true },
        { key: K.grossSales,           label: "Gross sales",             kind: "currency", minWidth: 140, hiddenByDefault: true },
