...
export const STAFF_ATTENDANCE_REPORT: ReportDefinition = {
    ...
    columns: [
        ...
        { key: K.scheduledHours,   label: "Hours scheduled",   kind: "number", minWidth: 160, calc: "Σ shift hours in the period" },
        { key: K.actualHours,      label: "Hours worked",      kind: "number", minWidth: 140, calc: "Σ clocked hours" },
