...
export const PAYMENTS_REPORT: ReportDefinition = {
    ...
    columns: [
        ...
        { key: K.paymentId,      label: "Payment #",            kind: "id",       minWidth: 180, hiddenByDefault: true },
        ...
        { key: K.itemName,       label: "Item",                 kind: "text",     minWidth: 220 },
        { key: K.revenueCategory,label: "Sale category",        kind: "text",     minWidth: 160, hiddenByDefault: true },
        ...
        { key: K.cardType,       label: "Card type",            kind: "text",     minWidth: 120, hiddenByDefault: true },
        { key: K.paymentType,    label: "Payment type",         kind: "text",     minWidth: 140, hiddenByDefault: true },
        { key: K.paymentStatus,  label: "Payment status",       kind: "status",   minWidth: 140 },
        { key: K.failureReason,  label: "Failure reason",       kind: "text",     minWidth: 200 },
        ...
        { key: K.processorFee,   label: "Processor fee",        kind: "currency", minWidth: 140, hiddenByDefault: true },
        { key: K.netPayout,      label: "Net payout",           kind: "currency", minWidth: 140, calc: "Payment − Processor fee", hiddenByDefault: true },
    ],
