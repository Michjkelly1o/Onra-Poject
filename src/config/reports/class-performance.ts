...
export const CLASS_PERFORMANCE_REPORT: ReportDefinition = {
    ...
    columns: [
        ...
        { key: K.capacity,          label: "Capacity",          kind: "number",  minWidth: 120, calc: "Set by class config" },
        { key: K.booked,            label: "Booked",            kind: "number",  minWidth: 120, calc: "Attended + No-shows + Late cancellations" },
        { key: K.attended,          label: "Attended",          kind: "number",  minWidth: 130, calc: "Count of check-ins" },
        { key: K.noShows,           label: "No-shows",          kind: "number",  minWidth: 130, calc: "Booked − Attended − Late cancellations" },
        { key: K.lateCancellations, label: "Late cancellations", kind: "number", minWidth: 180, calc: "Count" },
        { key: K.waitlisted,        label: "Waitlisted",        kind: "number",  minWidth: 130, calc: "Count" },
        { key: K.waitlistConverted, label: "Waitlist converted", kind: "number", minWidth: 170, calc: "Count" },
