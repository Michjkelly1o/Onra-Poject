...
export const TOTAL_SALES_REPORT: ReportDefinition = {
    ...
    columns: [
        ...
        { key: K.paymentAmountDue, label: "Amount Due",                   kind: "currency", minWidth: 180, calc: "Net − Amount Paid", hiddenByDefault: true },
        { key: K.netPaymentAmount, label: "Amount Paid",                  kind: "currency", minWidth: 180, hiddenByDefault: true },
