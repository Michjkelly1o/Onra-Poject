...
export const TOTAL_SALES_REPORT: ReportDefinition = {
    ...
    columns: [
        ...
        { key: K.netBeforeTax,     label: "Net sales after discount, before tax", kind: "currency", minWidth: 240, calc: "Gross − Discount", hiddenByDefault: true },
        ...
        { key: K.paymentAmountDue, label: "Payment amount due",           kind: "currency", minWidth: 180, calc: "Net − Net payment amount", hiddenByDefault: true },
        { key: K.netPaymentAmount, label: "Net payment amount",           kind: "currency", minWidth: 180, hiddenByDefault: true },
        { key: K.paymentMethod,    label: "Payment method",               kind: "text",     minWidth: 140, hiddenByDefault: true },
