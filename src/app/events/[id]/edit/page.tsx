...
// Edit-event route — reads the item from the store, maps the persisted
// `marketing_items` row back into the form's working shape, and hands it to
// EventFormPage in edit mode. Saving patches the same row via
