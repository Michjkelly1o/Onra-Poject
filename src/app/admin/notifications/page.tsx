...
export default function NotificationsPage() {
    ...
    // the numbers always describe what the user will actually see.
    ...
    // Filtered list for the active tab (branch + tab combined).
    const filtered = useMemo(
        () => activeTab === "all" ? branchScoped : branchScoped.filter(n => n.tab === activeTab),
    ...
    return (
        ...
        <div className="flex flex-col gap-6">
            ...
            {/* Bordered view card — fixed `h-[760px]` mirrors the
                ...
                picker sits inside the card, anchored above the Today
                section so it travels with the feed (and stays visible
            ...
            <div className="relative h-[760px] border-1 border-[#e4e7ec] rounded-[20px] bg-white overflow-hidden flex flex-col">
                ...
                {filtered.length === 0 ? (
                    ...
                    <div className="flex-1 min-h-0 overflow-y-auto scrollbar-hide px-6 pt-5 pb-8">
