...
const CATEGORIES: ReportCategory[] = [
    {
        ...
        items: [
            ...
            { slug: "tax-vat-export",      label: "VAT Export"                   },
            { slug: "gift-cards",          label: "Gift Cards"                   },
            { slug: "revenue-recognition", label: "Revenue Recognition"          },
            { slug: "revenue-per-class",   label: "Class Revenue"                },
            { slug: "arpm",                label: "Revenue per Member"           },
    ...
    },
    {
        ...
        items: [
            ...
            { slug: "frozen",               label: "Frozen Plans"                     },
            { slug: "intro-offers",         label: "Intro Offers"                     },
            { slug: "upgrades-downgrades",  label: "Plan Changes"                     },
        ],
    },
    {
        id: "customer",
    ...
    },
    {
        ...
        items: [
            ...
            { slug: "cancellations-noshows", label: "Class Cancellations & No-shows" },
