...
// ─────────────────────────────────────────────────────────────────────────────
//
// This IS the live "Insights" surface (formerly the KPI module, renamed +
// moved from the old /admin/kpi route to /admin/insights on 2026-08-11; the
// old mock Insights page was deleted). Metric catalogue from
// new-prd/Onra_KPI_Catalogue.pdf. Six category tabs —
// Financial · Client · Class · Private · Recovery · Marketing — each
// rendered as a metric-tile-only grid:
//
//   1. Tabs strip
