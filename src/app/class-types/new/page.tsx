    ...
    return (
        <div ref={ref} className="relative">
            <button
                type="button"
                onClick={() => setOpen(p => !p)}
                className="flex items-center gap-1.5 h-9 px-3 border border-[var(--colors-border-primary)] rounded-[8px] text-[14px] font-semibold text-[var(--colors-text-secondary)] bg-white hover:bg-[var(--colors-bg-secondary)] transition-colors shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]">
...
// The image upload lives in `src/components/ui/ImageBannerUpload.tsx` —
// shared with class schedule / promotions / campaigns / services so every
// create + edit form renders the same tile + right-column layout.
        ...
        <button
            ...
            className={cn(
                ...
                checked
                    ...
                    : "bg-white border-[var(--colors-border-primary)] hover:border-[var(--colors-secondary-600)]",
            )}
        >
        ...
        <div className="bg-white border border-[var(--colors-border-secondary)] rounded-[20px] flex flex-col flex-1 min-w-0 overflow-hidden h-full">
            ...
            <div className="flex-1 overflow-y-auto scrollbar-hide p-6 flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-4">
                    {/* Image banner — label is embedded in the shared uploader's
                        right column per Figma 7781:220725, no wrapping FormField. */}
                    <ImageBannerUpload
            ...
            <div className="flex-1 overflow-y-auto scrollbar-hide p-6 flex flex-col gap-4">
                ...
                <div className="border border-[var(--colors-border-secondary)] rounded-[12px] p-4 flex flex-col gap-4 shadow-[0px_1px_1px_rgba(16,24,40,0.05)]">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <span className="inline-flex items-center px-2 py-[2px] rounded-full text-[12px] font-medium bg-[var(--colors-bg-secondary)] border border-[var(--colors-border-secondary)] text-[var(--colors-text-secondary)] shrink-0">
                ...
                {/* Info alert */}
                <div className="flex items-start gap-4 px-4 py-4 bg-[var(--colors-tertiary-50)] border border-[var(--colors-border-secondary)] rounded-[12px] shadow-[0px_1px_1px_rgba(16,24,40,0.05)]">
            ...
            <div className="flex flex-col flex-1 overflow-hidden">
                ...
                <div className="flex items-center gap-3 px-6 h-[72px] shrink-0">
                    ...
                    <div className="flex flex-col gap-1.5 flex-1 min-w-0">
                        <h1 className="font-semibold text-[20px] leading-[30px] text-[var(--colors-text-primary)]">Create new template</h1>
