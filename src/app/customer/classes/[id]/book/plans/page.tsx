                        ...
                        >
                            ...
                            <div className="flex min-w-0 flex-1 flex-col gap-1">
                                <div className="flex flex-col">
                                    <span className="truncate text-sm font-medium leading-5 text-[#101828]">{plan.name}</span>
                                    <span className="truncate text-sm font-normal leading-5 text-[#475467]">{plan.sub}</span>
                                </div>
                                <span className="text-sm font-semibold leading-5 text-[#658774]">AED {plan.price}</span>
                            </div>
                            {qty > 0 ? (
                                <span className="flex size-9 shrink-0 items-center justify-center rounded-full border border-[#658774] bg-white text-sm font-medium leading-5 text-[#344054]">
                                    {qty}
                                </span>
                            ) : (
                ...
                <div className="sticky bottom-0 z-10 px-4 pb-[max(16px,env(safe-area-inset-bottom))] pt-2">
                    ...
                    >
                        <div className="flex min-w-0 flex-1 flex-col">
                            ...
                            <span className="text-sm font-semibold leading-5 text-[#101828]">AED {cartTotal()}</span>
                        </div>
