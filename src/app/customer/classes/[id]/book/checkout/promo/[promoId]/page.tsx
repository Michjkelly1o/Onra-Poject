...
// ─────────────────────────────────────────────────────────────────────────────
// Customer — Promo detail (`/…/checkout/promo/[promoId]`) — Figma 3697-67938
// ─────────────────────────────────────────────────────────────────────────────
//
// The full voucher: banner, headline + "1x" badge, description, and a divided
// list of terms (eligibility · discount · code · locations · validity). The
// sticky "Apply promo" button sets the cart promo and returns to checkout.
        ...
        <div className="flex min-h-full flex-col">
            ...
            {!promo ? (
                <div className="flex flex-1 items-center justify-center px-6 text-center">
                    <p className="text-sm font-normal text-[var(--colors-text-tertiary)]">This promo is no longer available.</p>
                </div>
            ) : (
                <>
                    <div className="flex flex-1 flex-col gap-8 px-4 pb-6 pt-2">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-sm font-normal leading-5 text-[var(--colors-text-tertiary)]">{promo.description}</p>
                        </div>

                        <div className="flex flex-col gap-4">
                            <TermRow icon={Tag01}>Eligible for package purchases</TermRow>
