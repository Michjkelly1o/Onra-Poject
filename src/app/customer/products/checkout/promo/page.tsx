...
// Customer — Products promo list (`/customer/products/checkout/promo`) — Figma 3704-78631 / 78661
// Sticky code field (Timezone pattern) with inline error state; voucher cards.
// Apply/Cancel sets the cart promo and returns to the Products checkout.
...
export default function ProductsPromoListPage() {
