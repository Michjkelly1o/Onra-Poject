...
// Customer — Products promo detail (`/customer/products/checkout/promo/[promoId]`) — Figma 3704-78762
// The full voucher + Apply; sets the cart promo and returns to the Products checkout.
...
const CHECKOUT = "/customer/products/checkout";
...
export default function ProductsPromoDetailPage() {
