...
function MarketingSidebarBanner({ vm }: { vm: MarketingDetailVM }) {
    ...
    // Banner — verbatim match for the customer-side campaign carousel
    // (`src/components/customer/home/WhatsOn.tsx`): same aspect-[343/140]
    // tile + `object-cover` fit. Admin preview and customer render are
    // now pixel-for-pixel identical (client 2026-07-22).
    return (
        ...
        <div className="w-[320px] shrink-0 bg-white border border-[var(--colors-border-secondary)] rounded-[20px] flex flex-col overflow-hidden">
            ...
            <div className="flex flex-col flex-1">
                ...
                <div className="px-6 pb-6 mt-auto">
                    ...
                    <p className="text-[14px] text-[var(--colors-text-quaternary)] mb-4">Marketing actions</p>
...
function MarketingDetailPageInner() {
    ...
    function handleAction(a: "edit" | ModalAction) {
        if (a === "edit") {
            ...
            // campaign card uses — no more full-page /marketing/[id]/edit route.
            openMarketingFormPanel({ kind: "campaign", mode: "edit", id });
            return;
        }
        setConfirmAction(a);
    }
        ...
        <div className="h-screen bg-white flex flex-col overflow-hidden">
            ...
            <div className="flex items-center gap-3 px-6 h-[72px] shrink-0">
                ...
                <div className="flex flex-col gap-1.5 flex-1 min-w-0">
                    <h1 className="font-semibold text-[20px] leading-[30px] text-[var(--colors-text-primary)]">Marketing details</h1>
