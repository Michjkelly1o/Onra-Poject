...
function ClassCard({ cls, size, absolute, moreCount, onClick }: ClassCardProps) {
    ...
    if (size === "md") {
        ...
        return (
            ...
            >
                <p className="text-[14px] font-medium leading-[18px] line-clamp-1" style={{ color: c.text }}>
                    {cls.name}
                </p>
...
function FilterSidePanel({ open, onClose, applied, onApply, onClear }: {
    open: boolean;
    onClose: () => void;
    applied: FilterState;
...
function DayView({ dateISO, classes, branchId, businessHoursRows, onClassClick }: {
    dateISO: string;
...
function WeekView({ classes, weekStart, branchId, businessHoursRows, onClassClick }: {
    classes: ClassSchedule[];
    weekStart: string;
    branchId: string;
    businessHoursRows: BusinessHours[];
...
function MonthView({ classes, monthYear, branchId, businessHoursRows, onClassClick }: {
    classes: ClassSchedule[];
    monthYear: string;
    branchId: string;
    businessHoursRows: BusinessHours[];
