...
// DAY_FULL now imported from @/components/ui/TimeDropdown (shared).
...
// TimeDropdown / DEFAULT_TIME_SLOTS / fmtTime / fmtSlotRange now imported from
// @/components/ui/TimeDropdown (shared with the AI-agent recurrence editor).
...
// TimeDropdown now imported from @/components/ui/TimeDropdown (shared).
