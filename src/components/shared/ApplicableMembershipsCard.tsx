...
export function ApplicableMembershipsCard({
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            {/* Packages accordion */}
            <div className="border-1 border-[var(--colors-border-secondary)] rounded-[12px] p-4 flex flex-col gap-4 shadow-[0px_1px_1px_rgba(16,24,40,0.05)]">
                {/* Accordion header */}
                <div className="flex items-center gap-4">
                    <div className="flex-1 min-w-0">
                        <p className="text-[14px] font-medium text-[var(--colors-text-primary)]">Packages</p>
                        <p className="text-[14px] text-[var(--colors-text-quaternary)]">The class can be used on multiple packages</p>
                    </div>
            ...
            {/* Info alert */}
            <div className="flex items-start gap-4 px-4 py-4 bg-[var(--colors-tertiary-50)] border-1 border-[var(--colors-border-secondary)] rounded-[12px] shadow-[0px_1px_1px_rgba(16,24,40,0.05)]">
