...
import {
    XClose, ChevronLeft, ArrowUp, ArrowDown, ChevronSelectorVertical,
...
// ─── Pagination ────────────────────────────────────────────────────────────
//
// Lifted verbatim from /admin/customers (Pagination local component) so the
// reports module shares the exact same chrome — per-page dropdown opens
// upward, "Page X of Y" label, Previous/Next pills, top divider.
