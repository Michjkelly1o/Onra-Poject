...
export const WIDGET_CATALOG: WidgetMeta[] = [
    ...
    // v83 Phase 5 (client 2026-07-24) — the differentiator surface. Ranked
    // list of open follow-up tasks generated by the Phase-4 engine. Rank
    // formula: `(customer LTV × freshness × trigger weight)`. Row click
    // navigates to the customer profile Follow-ups tab.
    { id: "leads-to-follow-up",  title: "Leads to follow up",                description: "", category: "Customer",
      info: "Auto-detected leads that need staff action, ranked by value and freshness." },
    // ─── Class ──────────────────────────────────────────────────────────
