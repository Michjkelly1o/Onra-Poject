...
export function BranchSelectorSheet({ open, onClose }: { open: boolean; onClose: () => void }) {
    ...
    return (
        <CustomerSheet open={open} onClose={onClose} tall>
            ...
            {/* Options */}
            <div className="mt-2 flex min-h-0 flex-1 flex-col overflow-y-auto [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                {showAll && (
                    <BranchRow
                        name="All branches"
            ...
            {/* Hint */}
            <div className="mt-4 flex shrink-0 items-start gap-3 rounded-xl border border-[var(--brand-primary)] bg-[var(--brand-tertiary)] p-4">
