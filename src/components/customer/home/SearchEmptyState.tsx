...
export function SearchEmptyState({
    ...
    return (
        <div className="flex flex-col items-center gap-6 px-6 text-center">
            {/* Illustration */}
            <div className="flex h-[120px] w-[156px] flex-col items-center gap-2.5 rounded-[13px] bg-[var(--colors-bg-secondary)] p-2.5 drop-shadow-[0px_0.8px_0.8px_rgba(16,24,40,0.05)]">
                <div className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-white shadow-[0px_1px_3px_0px_rgba(0,0,0,0.02),-2px_3.5px_8px_0px_rgba(0,0,0,0.02)]">
                    <Icon className="size-6 text-[var(--colors-text-secondary)]" aria-hidden />
                </div>
                <div className="flex w-full flex-1 flex-col justify-between">
                    <div className="flex w-full flex-col gap-1.5">
                        <div className="h-2.5 w-full rounded-full bg-[var(--colors-bg-tertiary)]" />
                        <div className="flex w-full gap-1.5">
                            <div className="h-2.5 flex-1 rounded-full bg-[var(--colors-bg-tertiary)]" />
                            <div className="h-2.5 flex-1 rounded-full bg-[var(--colors-bg-tertiary)]" />
                        </div>
                    </div>
                    <div className="flex w-full justify-center">
                        <div className="h-2.5 w-[76px] rounded-full bg-[var(--colors-bg-tertiary)]" />
                    </div>
                </div>
            </div>
