...
**Ask via ask_questions, one step at a time, in this order. EVERY step MUST include a stepLabel (e.g. "Class details") and a title so the step's card renders in the chat — never send an ask_questions step with an empty stepLabel/title, or the chat shows nothing for that step:**
