...
- **ask_class_details** / **ask_location_instructor** / **ask_repeat** / **ask_publish_confirm** — these BUILD the class-creation questions from the live studio data and show them above the composer. For the CLASS flow you MUST use these instead of composing ask_questions yourself — that keeps the questions identical every time. You only read the picked answer back.
