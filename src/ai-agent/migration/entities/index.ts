...
import { promoCodesEntity } from "@/ai-agent/migration/entities/promo-codes";
...
import { walletTransactionsEntity } from "@/ai-agent/migration/entities/wallet-transactions";
import { issuedGiftCardsEntity } from "@/ai-agent/migration/entities/issued-gift-cards";
...
import { retailCategoriesEntity } from "@/ai-agent/migration/entities/retail-categories";
import { retailProductsEntity } from "@/ai-agent/migration/entities/retail-products";
...
export const ENTITIES: Record<EntityKey, EntityDef> = {
    ...
    wallet_transactions: walletTransactionsEntity,
    issued_gift_cards: issuedGiftCardsEntity,
    ...
    retail_categories: retailCategoriesEntity,
    retail_products:   retailProductsEntity,
};
