...
export function ParticleOrb({ size = 72 }: { size?: number }) {
    ...
    useEffect(() => {
        ...
        const cTop = new THREE.Color("#94aeaf"); // light teal highlight (rich blue green-200)
        const cMid = new THREE.Color("#457175"); // brand teal (rich blue green-400)
        const cBot = new THREE.Color("#10373a"); // deep teal shadow (rich blue green-700)
