...
/**
 * A sphere formed by particles, rendered with three.js. Auto-rotates slowly;
 * GSAP handles a smooth scale-in entrance and a gentle continuous "breathing".
 * Colored with the Onra brand greens (light at the top, deep at the bottom).
 */
export function ParticleOrb({ size = 132 }: { size?: number }) {
  ...
  return (
    <div
      ref={mountRef}
      style={{ width: size, height: size, margin: "0 auto 18px" }}
      aria-hidden
    />
  );
}
