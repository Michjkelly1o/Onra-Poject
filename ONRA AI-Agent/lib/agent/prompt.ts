...
import { schemaForPrompt } from "@/lib/data/catalog";
import { VIZ_FRAMEWORK } from "@/lib/agent/vizGuide";

export function buildInsightPrompt(ctx: AuthContext, today: string): string {
  const scope =
    ctx.branchScope === "all"
